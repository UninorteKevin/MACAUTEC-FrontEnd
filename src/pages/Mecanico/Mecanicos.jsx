...
import MecanicoFila from './Fila';
import { Link } from 'react-router-dom';
import Form from 'react-bootstrap/Form'
import { Card, Row, Col, Button } from "react-bootstrap";

export default class Mecanicos extends Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3999/api/users/mecanicos')
          .then(res => {
    ...
    DataTable() {
        return this.state.filtrados.map((res, i) => {
            return <MecanicoFila obj={res} key={i} />;
        });
    }
        ...
        return (<div className="table-wrapper">
          ...
          <Row className = "mb-3">
              ...
              <Col md="3" className = "px-3 d-flex align-items-center justify-content-center">
                <Link className="btn btn-success rounded-pill" to={"/mecanicos/nuevo/"}>
                    Nuevo
                </Link>
              </Col>
          </Row>
